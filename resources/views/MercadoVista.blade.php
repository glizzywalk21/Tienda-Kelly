...
<body>
    <section>
        <div class="mt-4 ml-3">
            ...
            <div class="w-[30%]">
                <h3 class="font-bold text-xl text-end">Kelly</h3>
            </div>
        </div>
        ...
        <div class="mt-5">
            ...
            <div class="flex justify-center mt-14">
                <img class="w-[80%] h-40 overflow-hidden object-cover" src="{{ asset('images/img.png') }}"
                    alt="User Icon">
            </div>
            ...
            <div class="bg-gray-900 rounded-2xl w-64 h-14 flex justify-around">
                <div class="flex items-center  ">
                    <a href="{{ route('usuarios.index') }}"><img class="w-6"
                            src="{{ asset('images/HomeIcon.png') }}" alt="User Icon"></a>
                </div>

                <div class="flex items-center">
                    <a href="{{ route('usuarios.carrito') }}" class=" bg-white rounded-full p-[0.25rem] "><img class="w-6"
                            src="{{ asset('images/CarritoSelectedIcon.png') }}" alt="User Icon"></a>
                </div>

                <div class="flex items-center">
                    <a href="{{ route('usuarios.reservas') }}"><img class="w-6" src="{{ asset('images/FavIcon.png') }}"
                            alt="User Icon"></a>
                </div>
                <div class="flex items-center">
                    <a href="./UserEditarPerfil"><img class="w-6" src="{{ asset('images/UserIcon.png') }}"
                            alt="User Icon"></a>
                </div>
            </div>
