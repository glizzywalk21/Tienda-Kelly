...
<body class="bg-gradient-to-br from-indigo-200 via-blue-100 to-white min-h-screen flex items-center justify-center">
    <div class="md:flex w-full h-screen shadow-lg bg-white rounded-xl overflow-hidden">
        ...
        <div class="md:w-1/2 p-10 flex flex-col justify-center">
            ...
            <!-- Formulario -->
            <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-5 max-w-sm mx-auto w-full">
                <?php echo csrf_field(); ?>
                <!-- Email -->
                <div>
                    ...
                    <?php if($errors->has('usuario')): ?>
                        <div class="text-red-500 text-sm mt-1"><?php echo e($errors->first('usuario')); ?></div>
                    <?php endif; ?>
                </div>
                ...
                <div>
                    ...
                    <?php if($errors->has('password')): ?>
                        <div class="text-red-500 text-sm mt-1"><?php echo e($errors->first('password')); ?></div>
                    <?php endif; ?>
                </div>
            ...
            <p class="text-center text-sm text-gray-600">
                ...
                <a href="<?php echo e(route('RegistroUser')); ?>" class="text-indigo-600 font-semibold hover:underline">Crear Cuenta</a>
            </p>
        </div>
        ...
        <div class="hidden md:flex md:w-1/2 flex-col items-center justify-center bg-gradient-to-tr from-indigo-100 via-blue-50 to-white relative">
            ...
            <img class="w-[70%] drop-shadow-2xl animate-fade-in" src="<?php echo e(asset('imgs/imagenindex.png')); ?>" alt="Login Image">
...
<?php /**PATH C:\Users\Amilcar\OneDrive\Documentos\GitHub\Tienda-Kelly\Tienda_Kelly\resources\views/LoginUser.blade.php ENDPATH**/ ?>