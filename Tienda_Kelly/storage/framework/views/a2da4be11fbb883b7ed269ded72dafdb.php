...
<body class="bg-gradient-to-br from-indigo-200 via-blue-100 to-white">
    <div class="md:flex min-h-screen">
            ...
            <div class="max-w-lg">
                ...
                <div class="mt-10 flex justify-center gap-4">
                    ...
                    <a href="<?php echo e(route('usuarios.create')); ?>"
                        ...
                        <img class="absolute left-4 w-6" src="<?php echo e(asset('imgs/play.png')); ?>" alt="User Icon">
                ...
                <div class="flex justify-center gap-5 mt-10">
                    <a href="https://www.facebook.com/DirectivaCentralMercadosSanSalvador/?locale=es_LA"
                        ...
                        <img class="w-6" src="<?php echo e(asset('imgs/facebook.png')); ?>" alt="Facebook">
                    </a>
                    <a href="https://x.com/SsMercados"
                        class="bg-blue-500 hover:bg-blue-600 p-2 rounded-full shadow-md transition">
                        <img class="w-6" src="<?php echo e(asset('imgs/twitter.png')); ?>" alt="Twitter">
                    </a>
                    <a href="https://www.instagram.com/explore/locations/198993770818162/mercado-central-de-san-salvador"
                        ...
                        <img class="w-6" src="<?php echo e(asset('imgs/instagram.png')); ?>" alt="Instagram">
                    </a>
                    <a href="https://www.linkedin.com/company/sansalvador"
                        ...
                        <img class="w-6" src="<?php echo e(asset('imgs/linkedin.png')); ?>" alt="LinkedIn">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="hidden md:flex justify-center items-center md:w-1/2 bg-gradient-to-tr from-indigo-100 via-blue-50 to-white">
            <img class="w-[80%] drop-shadow-2xl animate-fade-in" src="<?php echo e(asset('imgs/imagenindex.png')); ?>" alt="Imagen principal">
        </div>
    </div>
</body>

</html>
<?php /**PATH C:\Users\Amilcar\OneDrive\Documentos\GitHub\Tienda-Kelly\Tienda_Kelly\resources\views/Index.blade.php ENDPATH**/ ?>